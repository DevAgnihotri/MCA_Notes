...
### *Software Quality Fundamentals, Defects, Reviews, Measurement*
...
13. Determine the assumptions stated by Musa Basic execution model over Jelinski and Moranda Model. *(Section B – Q2c)*
...
20. Explain the objective of software testing process. *(Section A – Q1j)*
21. Demonstrate Functional requirements & Non-functional requirements with suitable example. *(Section B – Q2a)*
22. Describe the following verification methods in brief (Any Two):
    (a) Peer Reviews (b) Walkthroughs (c) Inspections *(Section B – Q2b)*
23. Explain the testing tools. Describe the characteristics of Modern testing tools. *(Section C – Q7a)*
24. Define Verification and Validation activities associated with V-Model. *(Section C – Q7b)*
